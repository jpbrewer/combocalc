...
- Canonical docs live under /docs and must remain current.
...
- public interfaces, load order, runtime dependencies, or file responsibilities:
  Update /docs/architecture.md per /skills/skill-architecture.md

Whenever code changes affect:
- DOM IDs, selectors, form behaviors, UI state logic tied to Webflow:
  Update /docs/webflow-contract.md per /skills/skill-webflow-contract.md
...
- If you touched DOM IDs / Webflow behavior: update /docs/webflow-contract.md.
- If you changed responsibilities, load order, or APIs: update /docs/architecture.md.
